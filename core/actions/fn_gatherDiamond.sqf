/*
	...
	Description:
	Gathers diamond, needs to be revised and changed.
*/
private["_sum"];
_sum = ["diamond",1,life_carryWeight,life_maxWeight] call life_fnc_calWeightDiff;

if(_sum > 0 && (typeOf (vehicle player) == "O_Truck_03_device_F")) then
{
	life_action_in_use = true;
	titleText["Baue Diamanten ab...","PLAIN"];
	titleFadeOut 5;
	sleep 5;
