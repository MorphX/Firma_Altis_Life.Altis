...
life_thirst = 100;
life_hunger = 100;
life_paycheck_period = 15; //Five minutes
life_cash = 0;
life_impound_car = 850;
life_impound_boat = 550;
life_impound_air = 1100;
life_istazed = false;
...
switch (playerSide) do
{
	case west: 
	{
		...
		life_paycheck = 30000; //Paycheck Amount
	};
	case civilian: 
	{
...
//[shortVar,reward]
life_illegal_items = [["heroinu",1000],["heroinp",6500],["cocaine",3000],["cocainep",3500],["marijuana",2000],["turtle",10000],["cannabis",2000],["illegalmoney",0.5],["froglsd",3000]];
...
life_chopshop_sell =
[
	["B_Quadbike_01_F", 			0], //Quad
	
	["C_Hatchback_01_F", 			11250], //Limosine
	["C_Hatchback_01_sport_F",		32500], //Sportlimosine
	
	["C_Offroad_01_F", 				16250], //Geländewagen
	["B_G_Offroad_01_F", 			37500], //Rebellen-Offroader
	["B_G_Offroad_01_armed_F", 		2000000], //Rebellen-Offroader (bewaffnet)
	
	["C_SUV_01_F", 					25000], //SUV
	
	["C_Van_01_transport_F", 		37500], //Van-Pritsche
	["C_Van_01_box_F", 				50000], //Van-Boxer
	
	["I_Truck_02_transport_F", 		125000], //Zamak offen
	["I_Truck_02_covered_F", 		162500], //Zamak abgedeckt
	["B_Truck_01_transport_F", 		200000], //Hemtt offen
	["B_Truck_01_covered_F", 		335000], //Hemtt abgedeckt
	["B_Truck_01_box_F", 			425000], //Hemtt Container
	["O_Truck_03_transport_F", 		187500], //Tempest offen
	["O_Truck_03_covered_F", 		300000], //Tempest abgedeckt
	
	["I_MRAP_03_F", 				750000], //Strider
	["B_MRAP_01_F", 				25000], //Hunter
	["O_MRAP_02_F", 				500000], //Ifrit
	//["B_MRAP_01_hmg_F", 			500000], //Bewaffneter Hunter
	
	["B_Heli_Light_01_F", 			300000], //Hummingbird
	
	["O_Heli_Light_02_unarmed_F", 	900000], //Orca
	//["O_Heli_Light_02_F", 		15000000], //Orda bewaffnet
	
	["I_Heli_Transport_02_F", 		2500000], //Mohawk
	
	["B_Heli_Transport_01_F", 		1750000], //Ghost-Hawk
	
	["I_Heli_light_03_unarmed_F", 	1250000], //Hellcat
	//["I_Heli_light_03_F", 		1000000], //Hellcat bewaffnet
	
	["C_Rubberboat", 				5000], //Gummiboot
	["C_Boat_Civil_01_F", 			17500], //Motorboot
	["C_Boat_Civil_01_police_F", 	10000], //Motorboot Polizei
	//["B_Boat_Armed_01_minigun_F", 100000], //Speedboot bewaffnet
	
	["B_SDV_01_F", 					75000] //Uboot
];
