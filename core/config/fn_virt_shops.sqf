...
switch (_shop) do
{
	...
	case "rebmarket": {["Rebellenmarkt",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","vitem_repairkit","vitem_firstaidkit","box","uitem_handcuffs"], ["reb"]]};
	case "donatormarket": {["Donatormarkt",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","vitem_repairkit","vitem_firstaidkit","box","uitem_handcuffs"], ["donator"]]};
	...
	case "oil": {["Amerikanischer Ölhändler",["oilp","fuelF"]]};
	...
	case "cop_gear": { ["Cop-Ausrüstung", ["uitem_handcuffs","spikeStrip","fuelF","vitem_repairkit","vitem_firstaidkit","box","uitem_bd_mk1_bleachweapon","uitem_bd_mk1_ammo","uitem_troll_taschentuch","uitem_troll_nuckel","uitem_troll_bitering","uitem_troll_money"], ["cop"]] };
