...
*/
if(life_action_inUse) exitWith {hint "Eine Aktion wird bereits ausgeführt..."};
...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["Es sind keine Fahrzeuge zum Verkauf in der Nähe.","PLAIN"];};
